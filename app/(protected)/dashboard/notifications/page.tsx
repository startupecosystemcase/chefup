    ...
    <div className="p-4 md:p-6 lg:p-8 w-full bg-white dark:bg-dark transition-colors">
      <div className="mx-auto max-w-4xl w-full">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold mb-2 dark:text-white">Уведомления</h1>
            {unreadCount > 0 && (
        ...
        {notifications.length > 0 ? (
          ...
          <AnimatedCard className="bg-white dark:bg-dark/50 shadow-sm rounded-xl border border-gray-200/50 dark:border-border/50">
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 dark:text-white">Нет уведомлений</h3>
              <p className="text-sm text-muted-foreground dark:text-gray-400">
