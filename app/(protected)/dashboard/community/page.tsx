      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 md:mb-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold mb-6 md:mb-2 dark:text-white">Сообщества</h1>
                ...
                <StaggerItem key={event.id}>
                  ...
                  <div className="p-3 md:p-6 flex flex-col flex-1">
                    <div className="mb-6 md:mb-4">
                      ...
                      <h3 className="text-lg mb-6 md:mb-2 font-semibold dark:text-white">{event.title}</h3>
        ...
        <Dialog open={isInviteDialogOpen} onOpenChange={setIsInviteDialogOpen}>
          <DialogContent className="bg-white dark:bg-dark max-w-2xl">
            <DialogHeader className="mb-6">
              <DialogTitle className="text-2xl mb-6 md:mb-2">Пригласить участника</DialogTitle>
