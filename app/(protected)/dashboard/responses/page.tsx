    ...
    <div className="px-3 py-4 md:p-6 lg:p-8 bg-white dark:bg-dark transition-colors">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 md:mb-8">
          <h1 className="text-2xl md:text-3xl font-bold mb-6 md:mb-2 dark:text-white">Мои отклики</h1>
                  ...
                  <div className="p-3 md:p-6">
                    <div className="flex items-start justify-between mb-4 md:mb-4">
                      <div className="flex-1">
                        <h3 className="text-xl font-semibold mb-4 md:mb-3 dark:text-white leading-tight">{job.title}</h3>
