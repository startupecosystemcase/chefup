...
export const imagePaths = {
  cities: {
    astana: 'https://drive.google.com/uc?export=view&id=1C0D6qEL5Jow361oV5Qdan5POnjSJtmrM',
    almaty: 'https://drive.google.com/uc?export=view&id=1Dakn75j9M4_fmUS8Btm3CIWUI0-5fiKK',
    tashkent: 'https://drive.google.com/uc?export=view&id=1HbKaNBbK3J5xApE_uIJD2Lv9_eoyc2st',
    bishkek: 'https://drive.google.com/uc?export=view&id=1JwvNoFIs5k3xeRx_eXI01glAE6AsQY6L',
    baku: 'https://drive.google.com/uc?export=view&id=1K0B0C9wrwmjaatvl8FzJjzYko6FBbQqK',
    tbilisi: 'https://drive.google.com/uc?export=view&id=1R7NYwXrwHuXPRWGUObRiUdKiIp1CgpYJ',
