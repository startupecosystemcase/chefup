  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <AnimatedProgress value={completeness} className="h-4 rounded-full" />
      </div>

      {completeness === 100 && (
        <AnimatedBadge variant="default" className="flex items-center gap-3 px-4 py-2 w-fit bg-gradient-to-r from-primary to-[#FB923C]">
      ...
      {missingFields.length > 0 && (
        <div className="p-5 rounded-xl bg-gradient-to-br from-orange-50 to-orange-100/50 dark:from-orange-900/20 dark:to-orange-800/10 border border-orange-200/50 dark:border-orange-700/50 backdrop-blur-sm">
          <div className="flex items-start gap-4 mb-3">
            <AlertCircle className="w-5 h-5 text-orange-600 dark:text-orange-400 flex-shrink-0 mt-0.5" />
            <div>
              <p className="text-base font-medium text-orange-800 dark:text-orange-300 mb-2">Не заполнены обязательные поля:</p>
